...
📈 Built-in forecasting extends trends up to **2034** using **Linear Regression**, helping you see both historical and future patterns.  
""")
...
if query:
    ...
    with st.status("Processing…", expanded=False) as status:
        answer = respond(query)  # 👈 get the chatbot response (default bar)
